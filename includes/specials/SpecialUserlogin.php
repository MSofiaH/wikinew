...
class LoginForm extends SpecialPage {
	...
	function load() {
        ...
        $this->mCuenta = $request->getText('wpCuenta');
        $this->mCarrera = $request->getText('wpCarrera');
        $this->mCampus = $request->getText('wpCampus');
        $this->mCatedratico = $request->getCheck('wpCatedratico');
	...
	public function addNewAccountInternal() {
        ...
        $u->setCuenta( $this->mCuenta);
        $u->setCarrera( $this->mCarrera);
        $u->setCampus( $this->mCampus);
        $u->setCatedratico( $this->mCatedratico);
		...
		if ( !$wgAuth->addUser( $u, $this->mPassword, $this->mEmail, $this->mRealName, $this->mCuenta, $this->mCarrera, $this->mCampus,$this->mCatedratico) ) {
	...
	function mainLoginForm( $msg, $msgtype = 'error' ) {
        ...
        $template->set( 'cuenta', $this->mCuenta );
        $template->set( 'carrera', $this->mCarrera);
        $template->set( 'campus', $this->mCampus);
        $template->set( 'catedratico', $this->mCatedratico);

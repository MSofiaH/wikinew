...
class Preferences {
	...
	static function profilePreferences( $user, IContextSource $context, &$defaultPreferences ) {
        ...
        $defaultPreferences['campus'] = [
            'type' => 'info',
            'label-message' => "Campus:",
            'default' => $campus,
            'section' => 'personal/info',
        ];
        $defaultPreferences['carrera'] = [
            'type' => 'info',
            'label-message' => "Carrera:",
            'default' => $user->getCarrera(),
            'section' => 'personal/info',
        ];
        $defaultPreferences['cuenta'] = [
            'type' => 'info',
            'label-message' => "Cuenta:",
            'default' => $user->getCuenta(),
            'section' => 'personal/info',
        ];
        $esCatedratico = $user->getCatedratico();
        if($esCatedratico == 1){
            $defaultPreferences['catedratico'] = [
                'type' => 'info',
                'label-message' => "Tipo:",
                'default' => "Catedratico",
                'section' => 'personal/info',
		...
		$defaultPreferences['realname'] = array(
			...
			'type' => 'info',//$canEditPrivateInfo && $wgAuth->allowPropChange( 'realname' ) ? 'text' : 'info',
